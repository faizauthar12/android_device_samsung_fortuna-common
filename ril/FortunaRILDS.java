 ...
 * {@hide}
 */
public class FortunaRILDS extends RIL implements CommandsInterface {
    ...
    public FortunaRILDS(Context context, int networkMode, int cdmaSubscription,Integer instanceId) {
